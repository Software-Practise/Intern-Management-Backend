...
public class LoadDataCLR implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        UserModel cavillh = new UserModel(new Random().nextLong(),"Henry", "Cavill", "cavillh", "1234", new ArrayList<>(), new ArrayList<>(), "800 University Drive","Maryville", "Missouri", "64468", "(660) 123 4567", "Computer Science", "Undergraduate");
