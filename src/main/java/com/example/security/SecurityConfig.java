...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(HttpMethod.GET, "/faculty/**").hasAnyAuthority("ROLE_FACULTY");
        http.authorizeRequests().antMatchers(HttpMethod.POST, "/faculty/**").hasAnyAuthority("ROLE_FACULTY");
